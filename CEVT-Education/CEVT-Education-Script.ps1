...
#region removeCSV
$FileName1 = "c:\cevt-education\CEVT-Education-List.csv"
...
$FileName = "CEVT-Education-List"
ExcelToCsv -File $FileName

#copy $FileName1 S:\Scripts\CEVT-Education

copy $FileName1 '\\segot-s102\c$\scripts\CEVT-Education'
