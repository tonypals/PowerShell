...
{ cls
   hostname 
   Write-host "Ändrar inget då scriptet redan är kört" -ForegroundColor Green
...
# Changes the RoamingPreferredBandType to "2".
                ...
                write-host  "Detta är sökvägen för registervärdet för det trådlösa nätverkskortet `, $path"
                                                                           $path = $_.pspath 
