        ...
        {  
            ...
            { 
                $Props = @{ Type=$nestedmember.objectclass;
                            ...
                            DisplayName="";ParentGroup=$ADgroupname.name;
                            Enabled="";
                            Nesting=$nesting;
                ...
                { 
                    ...
                    if ($nestedmember)
                    {
                        ...
                        { 
                        $table | select type,name,displayname,parentgroup,nesting,enabled,GroupDescription,dn   
                        } 
                     }
                } 
...
Write-host "Users in OU-group is:" $OUGroup.count -ForegroundColor Green
...
Write-host "Users in Groups is:" $Groups.count -ForegroundColor Green
...
Write-host "There are" $members.count "members in" $GroupName -ForegroundColor Green

$path = "C:\temp\All-AdminGroupsMAXResultSize.csv"
